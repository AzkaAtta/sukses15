  ...
  const adaptedImages = await Promise.all(
    images.map(async (image) => {
      if (image?.url) {
        ...
        // BARIS YANG DIPERBAIKI: Deklarasi dan inisialisasi dengan null
        let _image = null; 
        ...
        // BARIS YANG DIPERBAIKI: Periksa apakah _image bukan null sebelum mengakses propertinya
